...
class Leads {
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug . '-style', plugins_url( 'assets/css/leads.css', dirname( __FILE__ ) ), array(), $this->version );
		}
	}
    ...
    $screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/leads.js', dirname( __FILE__ ) ), array( 'jquery' ), $this->version );
